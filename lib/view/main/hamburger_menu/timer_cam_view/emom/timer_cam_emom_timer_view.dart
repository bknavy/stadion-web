...
class TimerCamEmomTimerViewController extends GetxController {
...
class TimerCamEmomTimerView extends GetView<TimerCamEmomTimerViewController> {
  const TimerCamEmomTimerView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(TimerCamEmomTimerViewController());
    return Scaffold(
      backgroundColor: colorScheme.background,
      body: GetBuilder<TimerCamEmomTimerViewController>(builder: (controller) {
        return Stack(
          children: [
            ///바탕 이미지
            Image.asset(
            ...
            Center(
              child: Image.asset(
                'assets/images/timer_cam_emom_count.png',
                width: 562,
                height: 562,
                //fit: BoxFit.cover,
              ),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: HeadlineSmallText(
                            text: TimerCamEmomTimerViewController
