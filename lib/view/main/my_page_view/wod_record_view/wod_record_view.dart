...
class WodRecordViewController extends GetxController {
  var wodSortController = TextEditingController();

  String isWodSort = '';

  void applyWodSort(String value) {
    isWodSort = value;
    wodSortController.text = '${isWodSort}';
    update();
  }
  ...
  void SortFind() {
    Get.dialog(
      SelectOnePopupView(
          applyWodSortAtSub: applyWodSort,
...
class WodRecordView extends GetView<WodRecordViewController> {
  const WodRecordView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(WodRecordViewController());
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              MainScreenTextFormField(
                ...
                controller: controller.wodSortController,
                hintText: 'SORT',
              ),
            ],
          ),
