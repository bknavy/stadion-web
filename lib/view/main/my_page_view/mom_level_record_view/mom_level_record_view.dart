...
class MomLevelRecordViewController extends GetxController {
  var momLevelSortController = TextEditingController();

  String isMomLevelSort = '';

  void applyMomLevelSort(String value) {
    isMomLevelSort = value;
    momLevelSortController.text = '${isMomLevelSort}';
    update();
  }
  ...
  void SortFind() {
    Get.dialog(
      SelectOnePopupView(
          ...
          applyMomLevelSortAtSub: applyMomLevelSort,
...
class MomLevelRecordView extends GetView<MomLevelRecordViewController> {
  const MomLevelRecordView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(MomLevelRecordViewController());
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              MainScreenTextFormField(
                ...
                controller: controller.momLevelSortController,
                hintText: 'SORT',
              ),
            ],
          ),
