...
class PasswordFindInputViewController extends GetxController {
...
class PasswordFindInputView extends GetView<PasswordFindInputViewController> {
  const PasswordFindInputView({Key? key}) : super(key: key);
  ...
  Column buildIdFindInputField() {
    return Column(
      children: [
        GetBuilder<PasswordFindInputViewController>(builder: (context) {
          return Column(
            children: [
              LoginTextFormField(
                onChanged: (value) {
              ...
              ButtonWithRollover(
                onTap: () {
                  Get.to(const PasswordFindSendView());
                },
