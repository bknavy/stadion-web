...
class AddressPopupView extends GetView<AddressPopupViewController> {
  const AddressPopupView(
      {Key? key,
      required this.applyAddressAtSub,
      required this.applyAddressDetailAtSub})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddressPopupViewController>(builder: (controller) {
      return AlertDialog(
